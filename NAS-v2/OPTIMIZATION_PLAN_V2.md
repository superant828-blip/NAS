...
- [x] 创建工具基类 (`api/tools/base.py`)
- [x] 实现权限引擎 (`api/permissions/`)
- [x] 重构 main.py 入口

### Phase 2: 核心工具 (2-3天) ✅ 已完成
- [x] 文件操作工具 (读/写/编辑/删除)
- [x] ZFS 管理工具
- [x] 共享服务工具 (SMB/NFS)

### Phase 3: 任务系统 (1-2天) ✅ 已完成
- [x] Job 管理器
- [x] 后台任务执行
- [x] 进度跟踪 API
...
### Phase 5: Agent 集成 (2-3天) ✅ 已完成
- [x] Agent 基类
- [x] 自然语言任务解析
- [x] 多步骤任务规划

### Phase 6: 路由层重构 (2026-04-02) ✅ 已完成
- [x] 模块化路由拆分
- [x] 新增 auth/files/photos/shares/storage/system 路由
- [x] 主程序集成模块化路由
